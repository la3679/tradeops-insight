...
typecheck:
	npm run typecheck
	uv run mypy apps/api/src apps/api/tests packages/ai_orchestration/src packages/ai_orchestration/tests packages/data_connectors/src packages/data_connectors/tests packages/domain/src packages/domain/tests
